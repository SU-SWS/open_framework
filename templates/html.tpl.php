...
<body class="<?php print $classes; ?> <?php print $page_layout; ?> <?php print $body_bg_type; ?> <?php print $body_bg_classes; ?> <?php print $content_order_classes; ?> <?php print $front_heading_classes; ?> <?php print $breadcrumb_classes; ?> <?php print $border_classes; ?> <?php print $corner_classes; ?> <?php print $bootstrap_version; ?> <?php print $font_awesome_version; ?>" <?php print $attributes;?> <?php if ($body_bg_classes): ?>style="background: url('<?php print file_create_url(theme_get_setting( 'body_bg_path')); ?>') repeat top left;"<?php endif; ?>>
  <?php print $page_top; ?>
  <?php print $page; ?>
