...
<div class="panel-display two-33-66 clearfix" <?php if (!empty($css_id)): print "id=\"$css_id\""; endif; ?>>
  ...
  <div class="container row-fluid clearfix">
    ...
    <div class="region region-two-33-66-25-third span3">
      <div class="region-inner clearfix">
        <?php print $content['two_33_66_25_third']; ?>
      </div>
    </div>
    <div class="region region-two-33-66-25-fourth span3">
      <div class="region-inner clearfix">
        <?php print $content['two_33_66_25_fourth']; ?>
      </div>
    </div>
  </div>
