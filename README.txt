Open Framework Theme for Drupal 8.x
...
The Open Framework theme is intended for Drupal version 8 only; it will not work with Drupal 7 or below.

-- INSTALLATION --

Download and extract the theme package in your /themes directory. As an admin, go to Manage > Appearance to enable the theme.
