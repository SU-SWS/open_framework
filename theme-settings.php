...
function open_framework_form_system_theme_settings_alter(&$form, &$form_state) {
 ...
 $form['background_container']['body_bg_classes'] = array(
  ...
  $form['packages_container']['font_awesome_version'] = array(
    ...
    '#options'       => array(
      'font-awesome-3' => t('Version 3.2.1 [<a href="http://fontawesome.io/3.2.1/" title="Font Awesome 3.2.1 official documentation">documentation</a>]'),
      'font-awesome-4' => t('Version 4.7.0 [<a href="http://fontawesome.io/" title="Font Awesome 4.7.0 official documentation">documentation</a>]'),
    ),
  );
