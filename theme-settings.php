...
function open_framework_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['packages_container']['bootstrap_version'] = array(
    ...
    '#options'       => array(
      'bootstrap-2' => t('Version 2.3.1 [<a href="http://getbootstrap.com/2.3.2/">documentation</a>] - <strong><em>Default</em></strong>'),
      'bootstrap-3' => t('Version 3.1.1 [<a href="http://getbootstrap.com">documentation</a>]'),
    ),
  );
  ...
  $form['packages_container']['font_awesome_version'] = array(
    ...
    '#options'       => array(
      'font-awesome-3' => t('Version 3.2.1 [<a href="http://fortawesome.github.io/Font-Awesome/3.2.1/" title="Bootstrap 3.2.1 official documentation">documentation</a>] - <strong><em>Default</em></strong>'),
      'font-awesome-4' => t('Version 4.1.0 [<a href="http://fortawesome.github.io/Font-Awesome/" title="Bootstrap 4.1.0 official documentation">documentation</a>]'),
    ),
  );
